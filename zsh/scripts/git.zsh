...
alias gcl="git clone"
alias gclm="git clone -b main"
alias gclb="git clone -b"
alias gcp="git cherry-pick"
alias gd="git diff -w"                                                    # ignore white space
alias gds='git diff -w --staged'                                          # diff staged
alias grs='git restore --staged'                                          # unstage
alias gst='git rev-parse --git-dir > /dev/null 2>&1 && git status || exa' # git status or exa
alias gu='git reset --soft HEAD~1'                                        # undo last commit
alias gpr='git remote prune origin'                                       # prune remote branches
alias ff='gpr && git pull --ff-only'                                      # fast forward
alias grd='git fetch origin && git rebase origin/master'                  # rebase develop
alias gbb='git-switchbranch'                                              # switch branch
